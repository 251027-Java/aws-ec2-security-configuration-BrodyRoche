...
|------|------|----------|------|--------|---------|
| 1    | SSH  | TCP      | 22   | 108.66.187.120/32| Admin access |
...
|---------|--------------|----------|
| Can't SSH to instance | SSH rule missing/wrong | Add/fix rule, allowing TCP 22 |
| Website not loading | HTTP(S) not allowed/app not running | Open ports 80/443 and run app |
| API calls timing out | Port 8080 rule missing/wrong | Add/fix rule, allowing TCP 8080 from 10.0.0.0/8 |
